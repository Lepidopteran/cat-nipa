//! Game specific Keys for decrypting NPA files

/* Chaos;Head Retail */
pub const CHAOS_HEAD: [u8; 256] = [
...
/* Chaos;Head Trial 1 */
pub const CHAOS_HEAD_TRAIL_1: [u8; 256] = [
...
/* Chaos;Head Trial 2 */
pub const CHAOS_HEAD_TRAIL_2: [u8; 256] = [
...
/* Muramasa Trial */
pub const MURAMASA_TRIAL: [u8; 256] = [
...
/*
	...
	*/
pub const ZOKU_SATSURIKU_NO_DJANGO: [u8; 256] = [
...
pub const ZOKU_SATSURIKU_NO_DJANGO_TRIAL: [u8; 256] = [
...
pub const LAMENTO_BEYOND_THE_VOID: [u8; 256] = [
    0xDF, 0x5F, 0x6E, 0xF7, 0xF5, 0xEF, 0x52, 0x5B, 0x7E, 0x25, 0xD7, 0x46, 0xBC, 0x92, 0x02, 0x2E,
    0x51, 0x7C, 0x39, 0x16, 0x2A, 0x18, 0x08, 0xEB, 0x0C, 0x97, 0x3A, 0xC7, 0xAC, 0xC6, 0xB0, 0x17,
    0x80, 0xD6, 0x86, 0x3C, 0xFB, 0xF9, 0xB1, 0x01, 0xA9, 0x79, 0x9E, 0xB3, 0x37, 0xDE, 0x19, 0xE7,
    0x2B, 0xC2, 0x28, 0x1E, 0x5D, 0x67, 0x22, 0x8E, 0x58, 0x1A, 0xCC, 0xEC, 0x44, 0x9D, 0xA7, 0x24,
...
pub const LAMENTO_BEYOND_THE_VOID_TRIAL: [u8; 256] = [
    0xDF, 0x5F, 0x6E, 0xF7, 0xF5, 0xEF, 0x52, 0x5B, 0x7E, 0x25, 0xD7, 0x46, 0xBC, 0x92, 0x02, 0x2E,
    0x51, 0x7C, 0x39, 0x16, 0x2A, 0x18, 0x08, 0xEB, 0x0C, 0x97, 0x3A, 0xC7, 0xAC, 0xC6, 0xB0, 0x17,
    0x80, 0xD6, 0x86, 0x3C, 0xFB, 0xF9, 0xB1, 0x01, 0xA9, 0x79, 0x9E, 0xB3, 0x37, 0xDE, 0x19, 0xE7,
    0x2B, 0xC2, 0x28, 0x1E, 0x5D, 0x67, 0x22, 0x8E, 0x58, 0x1A, 0xCC, 0xEC, 0x44, 0x9D, 0xA7, 0x24,
...
pub const SUMAGA_SPECIAL: [u8; 256] = [
...
/* Demonbane The Best */
pub const DEMONBANE_THE_BEST: [u8; 256] = [
...
/* Axanael + Trial */
pub const AXANAEL_TRIAL: [u8; 256] = [
...
pub const KIKOKUGAI_N2SYSTEM: [u8; 256] = [
...
/* Sonicomi Trial 2 */
pub const SONICOMI_TRIAL_2: [u8; 256] = [
...
/* Sumaga 3% Trial */
pub const SUMAGA_3_PERCENT_TRIAL: [u8; 256] = [
...
pub const GUILTY_CROWN_LOST_XMAS: [u8; 256] = [
...
pub const GUILTY_CROWN_LOST_XMAS_TRAILER: [u8; 256] = [
...
/* DRAMAtical Murder */
pub const DRAMATICAL_MURDER: [u8; 256] = [
...
pub const DRAMATICAL_MURDER_RE_CONNECT: [u8; 256] = [
